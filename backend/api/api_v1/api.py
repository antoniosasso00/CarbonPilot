...
from api.api_v1.endpoints import parts, catalog_parts, autoclaves, schedules, nesting, reports
...
api_router.include_router(autoclaves.router, prefix="/autoclaves", tags=["Autoclaves"])
